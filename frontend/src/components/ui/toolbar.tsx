...
// Radix's own tooltip rather than this project's, which is built on Base UI and has a
// different API (`render` instead of `asChild`). Kept local to the editor's chrome so the
